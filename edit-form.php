	...
	<div class="row align-items-center my-6">
			...
			<div class="container-relative">
				...
				<div class="block">
						...
						?>
						<h1> Editácia vybraného záznamu </h1>
						<form action="edit.php?id=<?php echo $id; ?>"  method="POST">
						<p>Meno: <br> <input type ="text" name="meno" value="<?php echo $meno ?>"><p>
						Priezvisko: <br> <input type="text" name="priezvisko" value="<?php echo $priezvisko ?>"><p>
						Vek: <br> <input type ="text" name="vek" value="<?php echo $vek ?>"><p>
						Krajina pôvodu: <br> <input type ="text" name="krajina_povodu" value="<?php echo $krajina_povodu ?>"><p>
						Pozícia: <br> <input type ="text" name="pozicia" value="<?php echo $pozicia ?>"><p>
						Tím: <br> <input type ="text" name="tim" value="<?php echo $tim ?>"><p>
