	...
	<div class="row align-items-center my-6">
			...
			<div class="container-relative">
				...
				<div class="block">
						...
						if($var){
							$sql="update hraci set meno='$meno', priezvisko='$priezvisko', vek='$vek', krajina_povodu='$krajina_povodu', pozicia='$pozicia', tim='$tim' where id = $id";
						...
						if ($var2){
						$sql2="update hraci set meno='$meno', priezvisko='$priezvisko', vek='$vek', krajina_povodu='$krajina_povodu', pozicia='$pozicia', tim='$tim' where id = $id";
						$res2=mysqli_query($var2,$sql2) or die ("registration error");
						} else {
							echo "<p style='color:red'><b>Nepodarilo sa pripojiť k druhému uzlu!</b></p>";
						}

						//príkazy pre tretí uzol
						$var3= mysqli_connect("$localhost3","$user3","$password3","$db3");
						if ($var3){
						$sql3="update hraci set meno='$meno', priezvisko='$priezvisko', vek='$vek', krajina_povodu='$krajina_povodu', pozicia='$pozicia', tim='$tim' where id = $id";
                        ...
                        echo "<b style='color:#28bd28'>Nové údaje:</b><br>";
